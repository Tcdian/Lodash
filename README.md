...
#### 计划用 TypeScript 仿写 lodash 的功能，主要是为了学习 TypeScript 更复杂的用法，复习 JavaScript 基础，和熟悉 lodash 用法

---

### 之前实现的放置在 [lodash_js](./lodash_js/tcdian-lodash.js)，存在很多错误，欢迎指正

最后完成 lodash 共 298 个函数,其中很多函数的实现没有完整的还原 lodash 函数的所有功能,并且很多的测试用例都比较少,很多函数的实现存在一些问题,这是我今后需要去修改和完善的地方.<br>

这次 lodash 的简单实现, 有几个我印象比较深的地方:
...
-   isEqualWith
    ...
    ```
-   \_baseIsEqual 是 isEqual 和 isEqualWith 功能基本类似, 区别在于 isEqualWith 接收一个比较函数 customizer, 我将两个函数的功能整合到了 \_baseIsEqual 中, 下面是 \_baseIsEqual 函数

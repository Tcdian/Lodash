...
function map<T, TResult>(collection: T[], predicate?: ArrayIterateeCustom<T, TResult>): TResult[];
function map<TResult>(collection: string, predicate?: StringIterateeCustom<TResult>): TResult[];
function map<K extends PropertyName, V, TResult>(
    collection: Record<K, V>,
    predicate?: RecordIterateeCustom<K, V, TResult>
): TResult[];
